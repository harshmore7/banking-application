...
public class BankServiceImpl implements BankService {
    ...
    @Override
    public void transfer(String requesterCustomerId, String fromAccount, String toAccount, BigDecimal amount) {
    ...
    @Override
    public void transferToBeneficiary(String requesterCustomerId, String fromAccount, String beneficiaryAccount, BigDecimal amount) {
        ...
        transfer(requesterCustomerId, fromAccount, beneficiaryAccount, amount);
    }

    @Override
    @Transactional(readOnly = true)
    public List<Transaction> getStatement(String requesterCustomerId, String accountNumber, LocalDateTime from, LocalDateTime to) {
        getOwnedActiveAccount(requesterCustomerId, accountNumber);
        if (from != null && to != null) {
            return transactionRepository.findByAccountAccountNumberAndTimestampBetweenOrderByTimestampDesc(accountNumber, from, to);
        }
